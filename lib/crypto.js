...
generateKeypair: function(){ 
  return window.crypto.subtle.generateKey(generationAlgorithm, true, 
    ["encrypt", "decrypt"]);
},
...
importKey: function(key){ 
  ...
  return window.crypto.subtle.importKey(exportFormat,key,ALGORITHM, true, 
...
veifyKey: function(generatedKey,resource){
  return window.crypto.subtle.sign(verifyAlgorithm, generatedKey, root.Crypto._string2ArrayBuffer(resource));
},
