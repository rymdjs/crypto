(function (){
  ...
  var Crypto = {
    ...
    generateKeyPair: function(bitlength) {
      return back._generateRSAKeypair(bitlength);
    },
    ...
    encryptText: function(key, text) {
      return this.encryptData(key, util.stringToArrayBuffer(text));
    },
